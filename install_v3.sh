...
MANIFEST_URL="https://raw.githubusercontent.com/nguyentrungempty/panel_n8n/refs/heads/main/manifest.json"
...
for file in "${files[@]}"; do
    ...
    for attempt in {1..3}; do
        if curl -s --connect-timeout 30 "https://raw.githubusercontent.com/nguyentrungempty/panel_n8n/refs/heads/main/$file" -o "$dest_path" 2>/dev/null; then
    ...
    if [ "$success" = false ]; then
        ...
        echo -e "${RED}     💡 Kiểm tra URL: https://raw.githubusercontent.com/nguyentrungempty/panel_n8n/refs/heads/main/$file${NC}"
    fi
done
